...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($formData['name']))    $errors[] = t('contact.name');
    if (!filter_var($_POST['email'] ?? '', FILTER_VALIDATE_EMAIL)) $errors[] = t('contact.email');
    if (empty($formData['message'])) $errors[] = t('contact.message');
...
<main class="page-contact">
  ...
  <form class="contact-form" method="POST" action="/en/contact/" novalidate>
